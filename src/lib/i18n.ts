...
const messages = {
  en: {
    ...
    activitiesDescription: 'Latest videos and active open-source projects.', swipe: 'Swipe to explore →',
    latestVideos: 'Latest videos', recentProjects: 'Recent projects', moreActivities: 'More platforms', moreActivitiesTitle: 'Elsewhere lately', viewChannel: 'View channel', viewProfile: 'View profile',
  ...
  'zh-CN': {
    ...
    activitiesDescription: '最近的视频与活跃开源项目。', swipe: '滑动查看更多 →',
    latestVideos: '最新视频', recentProjects: '最近项目', moreActivities: '更多平台', moreActivitiesTitle: '其他最近动态', viewChannel: '查看频道', viewProfile: '查看主页',
