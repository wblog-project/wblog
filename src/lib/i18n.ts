...
const messages = {
  en: {
    ...
    latestVideos: 'Latest videos', recentProjects: 'Recent projects', viewChannel: 'View channel', viewProfile: 'View profile',
  ...
  'zh-CN': {
    ...
    latestVideos: '最新视频', recentProjects: '最近项目', viewChannel: '查看频道', viewProfile: '查看主页',
